...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Sleding Distro | Distro Online telengkap dan terpercaya di Semarang</title> 
	<meta name="description" content="Distro, semarang, terlengkap, information, technology, jababeka, baru, murah"/>
	<meta name="keywords" content="Kaos, Murah, Semarang, Baru, terlengkap, harga, terjangkau" />
	<meta name="author" content="Dikky Ryan Pratama"/>
	<!-- end: Meta -->
...
<!---->
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Dapatkan kemudahan berbelanja di Sleding Distro Semarang, Kami menyediakan kebutuhan untuk fasion anda.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Anda bisa memesan produk kami melalui gadget kesayangan anda, belanja di Sleding Distro Semarang praktis dan mudah.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span3">
					...
					<h3>Tentang SledingDistro</h3>
					<p>
						SledingDistro adalah toko online yang bergerak di bidang fasion, sasaran kami semua kalangan baik muda maupun tua, mulai dari anak - anak dan orang dewasa.
					</p>
				...
				<div class="span3">
					...
					<h3>Alamat Kami</h3>
					Jalan Kumudasmoro Dalam Rt 03 Rw 01 Kelurahan Bongsari Kecamatan Semarang Barat <br />
                    Telp : 088229887396<br />
                    Email : <a href="mailto:dikkydbs@gmail.com">dikkydbs@gmail.com</a> / <a href="dikky@semarangkota.go.id">dikky@semarangkota.go.id</a>
				</div>
				<!-- end: Photo Stream -->
	...
	<div id="copyright">
		...
		<div class="container">
			...
			<p>
				Copyright &copy; <a href="http://sleding-c0de.ezyro.com">Sleding Distro 2021</a> <a href="http://bootstrapmaster.com" alt="Bootstrap Themes">Bootstrap Themes</a> designed by BootstrapMaster
			</p>
